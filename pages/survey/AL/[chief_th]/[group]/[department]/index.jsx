...
const SurveyBranch = () => {
    ...
    const fetchSurveyData = async () => {
        try {
            const response = await axios.get(`/api/survey/board/al/branch`, {
        ...
        <div className="mt-4 bg-white shadow-md text-xs w-full">
            ...
            {selectedBranch && (
                <div 
                    ...
                    onClick={() => router.push(`/survey/AL/${chief_th}/${group}/${department}/memo?branch=${selectedBranch}&startDate=${startDate}&endDate=${endDate}`)}
                >
