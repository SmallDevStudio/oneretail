...
const SurveyGroup = () => {
    ...
    const fetchSurveyData = async () => {
        try {
            const response = await axios.get(`/api/survey/board/pb/department`, {
            ...
            {selectedDepartment && (
                ...
                >
                    <h3 
                        ...
                        onClick={() => router.push(`/survey/verbatim?teamGrop=${teamGrop}&position=${position}&startDate=${startDate}&endDate=${endDate}`)}
                    >
                                    ...
                                    <li key={detail.value} style={{ color: detail.color }}>
                                        <div className="flex flex-row gap-4">
                                            ...
                                            <span
                                                ...
                                                onClick={() => 
                                                    router.push(
                                                        `/survey/verbatim?teamGrop=${teamGrop}&position=${position}&department=${selectedDepartment}&startDate=${startDate}&endDate=${endDate}&value=${detail.value}`
                                                    )
                                                }
                                            >
