...
const SurveyMemo = () => {
    ...
    const { position, department, startDate, endDate } = router.query;
    const teamGrop = "PB";
    ...
    const fetchSurveyData = async () => {
        try {
            // Fetch memo data
            const memoResponse = await axios.get(`/api/survey/board/pb/memo`, {
                params: { startDate, endDate, teamGrop, position, department },
            });
