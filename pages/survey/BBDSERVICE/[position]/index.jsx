        ...
        <div className="flex-1 flex-col p-2 mb-20">
            ...
            {selectedGroup && (
                ...
                >
                    ...
                    >
                        รายละเอียดสำหรับเขต: {selectedGroup}
                    </h3>
                    <span 
                                    ...
                                    <li key={detail.value} style={{ color: detail.color }}>
                                        <div className="flex flex-row gap-4">
                                            ...
                                            <span
                                                ...
                                                onClick={() => 
                                                    router.push(
                                                        `/survey/verbatim?teamGrop=${teamGrop}&position=${position}&group=${selectedGroup}&startDate=${startDate}&endDate=${endDate}&value=${detail.value}`
                                                    )
                                                }
                                            >
