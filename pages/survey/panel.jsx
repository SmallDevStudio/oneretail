                                ...
                                <div className="flex flex-row justify-between w-full ">
                                    ...
                                    >
                                         {comment.userId === userId  && (
                                            <MenuItem onClick={() => handleEditComment(comment._id)}>
                                                แก้ไขความคิดเห็น
                                            </MenuItem>
                                        )}
                            ...
                            <div className="flex flex-col bg-gray-100 rounded-xl p-1 w-full">
                                <div className="flex flex-row  w-full">
                                    <div className="flex flex-col w-[50px]">
                                        <Image
                                            src={reply?.userId === survey?.data?.userId ? "/images/survey/3.svg" : reply?.user?.pictureUrl}
                                            alt="sticker"
                                            width={50}
                                            height={50}
                                            className="rounded-full"
                                    ...
                                    <div className="flex flex-col w-full text-left ml-2 px-1">
                                        <div className="flex flex-row justify-between w-full ">
                                            ...
                                            >
                                                {reply.userId === userId  && (
                                                    <MenuItem onClick={() => handleEditReply(reply?._id, reply)}>
                                                        แก้ไขความคิดเห็น
                                                    </MenuItem>
                                                )}
