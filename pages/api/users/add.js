...
export default async function handler(req, res) {
    if (req.method !== "POST") {
        ...
        const { fullname, phone, address, pictureUrl, role, active, employee_id, line_id } = req.body;
        console.log(fullname, phone, address, pictureUrl, role, active, employee_id, line_id);
        await connetMongoDB();
