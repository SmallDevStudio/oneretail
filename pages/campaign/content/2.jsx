    ...
    return (
        <div>
            ...
            <div className="flex flex-col p-5">
                <span className="font-bold text-[#0056FF] text-xl mb-2">Login ทุกวัน ได้รางวัลสุดพิเศษ</span>
                <p className="text-md">เพียงแค่เพื่อนๆ Login เข้ามา ทุกวันต่อเนื่อง ครบ 30 ครั้ง ภายในวันที่ 15 สิงหาคม รับรางวัลสุด cute จาก One Retail Society ไปเลย </p>
            </div>
        </div>
    );
}
