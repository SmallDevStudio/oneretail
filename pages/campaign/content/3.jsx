    ...
    return (
        <div>
            ...
            <div className="flex flex-col p-5">
                <span className="font-bold text-[#0056FF] text-xl mb-2">ดูคลิปเพลิน Learn รับ point</span>
                <p className="text-md">ทุกคลิปในเมนู Learning และ Success Storyนอกจากได้ความรู้แล้ว ยังได้พ้อยท์ไปอีกด้วยน้า
                    กด Like ใส่ Comment กันได้เล้ย 
                    เชื่อเถอะ ยิ่งดู ยิ่งเพลิน ยิ่ง Learn ยิ่งได้ Point นะจ๊ะ 
                </p>
            </div>
        </div>
    );
