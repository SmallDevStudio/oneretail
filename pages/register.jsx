  ...
  const handleEmpIdChange = async (empId) => {
    ...
    try {
      ...
      const userCheckRes = await axios.get(
        `/api/users/checkEmpId?empId=${empId}`
      );
  ...
  return (
    <div className="flex flex-col justify-center p-5 bg-white">
      <div className="block justify-center items-center text-center mt-10 mb-2">
        ...
        <span
          className="text-xl font-black text-[#F2871F]"
          style={{ fontFamily: "ttb", fontWeight: "bold" }}
        >
      ...
      <div className="flex flex-col p-3">
        <div className="flex flex-col justify-center items-center text-center mb-4">
          <div
            className="flex flex-col justify-center items-center text-center mb-2"
          ...
          <span
            className="text-xl font-black text-[#1E3060]"
        ...
        <div className="block mb-2">
          ...
          <div className="text-red-500 text-sm font-bold text-left ml-10 h-2">
            {errors && (
              <div className="text-red-500 text-sm font-bold">{errors}</div>
            )}
          </div>
        </div>
        <div className="block mb-2">
            ...
            <div className="block">
              <ul className="text-sm font-light text-gray-900 dark:text-gray-400 list-disc ml-10 mb-4 mt-2 text-left">
                <li className="mb-2">
                  ...
                  ดังนั้นเรามุ่งมั่นที่จะปฏิบัติตามกฎหมายคุ้มครองข้อมูลส่วนบุคคล
                  (PD PA)
                  ในการเก็บรวบรวมใช้และประมวลผลข้อมูลส่วนบุคคลของคุณข้อมูลที่เราเก็บรวบรวมจะใช้เพื่อวัตถุประสงค์ที่เกี่ยวกับการให้บริการ
                  และปรับปรุงประสิทธิภาพของบริการของเราเก่านั้นและจะไม่นำข้อมูลของคุณไปใช้เพื่อวัตถุประสงค์อื่นๆโดยไม่ได้รับความยินยอมจาก
                  คุณล่วงหน้า
                </li>
                <li className="mb-2">
                  เราจะไม่เปิดเผยข้อมูลส่วนบุคคลของคุณแก่บุคคลที่สามได้ยกเว้น
                  เฉพาะในกรณีที่เราจำเป็นต้องทำเช่นนั้นตามกฎหมายหรือโดยคำสั่งของหน่วยงานราชการที่มีอำนาจ
                </li>
                <li className="mb-2">
                  ผู้ขออนุญาตใช้งานจะต้องไม่เผยแพร่ข้อมูลข่าวสารนี้ต่อบุคคลภายนอก
                  ttb โดยเด็ดขาด
                </li>
              </ul>
            </div>
