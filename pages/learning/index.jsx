...
export default function Learning() {
  ...
  const { data: contentsData1, error: contentsError1 } = useSWR(
    `/api/content/subcategory?subcategoryId=${subcategory}`,
    fetcher,
    {
      onSuccess: (data) => {
  ...
  const { data: contentsData2, error: contentsError2 } = useSWR(
    `/api/content/subcategory?subcategoryId=${subcategory2}`,
    fetcher,
    {
      onSuccess: (data) => {
  ...
  if (contentsError || contentsError1 || contentsError2)
    return (
      <p>
        Error: {contentsError || contentsError1 || contentsError2 || videoError}
      </p>
    );
