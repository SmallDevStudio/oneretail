...
const ExaminationForm = () => {
    ...
    useEffect(() => {
        ...
        } else if (examination?.questions) {
            // รีเซ็ต incorrectQuestions หากยังไม่ complete
            setIncorrectQuestions(examination.questions);
        }
    }, [useAnswers?.isComplete, examination?.questions]);
