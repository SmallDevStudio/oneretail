...
const FeedPage = () => {
  ...
  const { data, error, mutate, isValidating, isLoading } = useSWR(
    `/api/onesociety/feed?userId=${session?.user?.id}`,
    fetcher,
    {
      onSuccess: (data) => {
        setPosts(data.data);
                ...
                <g>
                  ...
                  <g>
                    <g>
                      <path
                        fill="currentColor"
                        d="M87.29,30.12c0,15.78,12.83,28.62,28.62,28.62,37.87-1.34,37.86-55.9,0-57.23-15.78,0-28.62,12.83-28.62,28.62ZM134.99,30.12c-.8,25.21-37.36,25.21-38.15,0,.8-25.21,37.36-25.21,38.15,0Z"
                      />
                      <path
                        fill="currentColor"
                        d="M115.96,60.23c-16.66,0-30.17-13.51-30.17-30.11S99.3,0,115.91,0c20.56.72,29.9,16.12,29.9,30.11,0,14-9.34,29.39-29.85,30.12ZM115.86,3c-14.9,0-27.06,12.16-27.06,27.12s12.16,27.12,27.12,27.12c12.93-.46,26.9-9.14,26.9-27.12,0-17.98-13.97-26.66-26.95-27.12ZM115.91,50.52h0c-9.6,0-20.13-6.37-20.57-20.36.44-14.08,10.98-20.45,20.58-20.45h0c9.6,0,20.13,6.37,20.57,20.36v.05s0,.05,0,.05c-.44,13.99-10.98,20.36-20.58,20.36ZM115.91,12.71c-8.2,0-17.2,5.46-17.58,17.45.38,11.9,9.38,17.36,17.58,17.36h0c8.19,0,17.17-5.45,17.58-17.41-.4-11.96-9.39-17.4-17.57-17.41h0Z"
                      />
                    </g>
                    <g>
                      <path
                        fill="currentColor"
                        d="M151.97,125c-2.63,0-4.77-2.14-4.77-4.77v-8.48c0-17.31-14.08-31.4-31.4-31.4s-31.4,14.08-31.4,31.4v7.18c0,2.63-2.13,4.77-4.77,4.77s-4.77-2.14-4.77-4.77v-7.18c0-22.57,18.36-40.93,40.93-40.93s40.93,18.36,40.93,40.93v8.48c0,2.63-2.13,4.77-4.77,4.77Z"
                      />
                      <path
                        fill="currentColor"
                        d="M151.97,126.5c-3.46,0-6.27-2.81-6.27-6.27v-8.48c0-16.48-13.41-29.9-29.9-29.9s-29.9,13.41-29.9,29.9v7.18c0,3.46-2.81,6.27-6.27,6.27s-6.27-2.81-6.27-6.27v-7.18c0-23.4,19.04-42.43,42.43-42.43s42.43,19.04,42.43,42.43v8.48c0,3.46-2.81,6.27-6.27,6.27ZM115.8,78.86c18.14,0,32.9,14.76,32.9,32.9v8.48c0,1.8,1.47,3.27,3.27,3.27s3.27-1.47,3.27-3.27v-8.48c0-21.74-17.69-39.43-39.43-39.43s-39.43,17.69-39.43,39.43v7.18c0,1.8,1.47,3.27,3.27,3.27s3.27-1.47,3.27-3.27v-7.18c0-18.14,14.76-32.9,32.9-32.9Z"
                      />
                    </g>
                  </g>
                </g>
        ...
        {activeTab === "feed" && (
          <div className="flex flex-col bg-gray-300 h-screen pb-20 max-w-screen overflow-x-hidden">
            {isValidating && posts.length === 0 ? (
              ...
              <Feed posts={filteredPosts} user={user} mutate={mutate} />
            )}
          </div>
        )}
