             ...
             <div className="flex flex-col p-3">
                <form onSubmit={handleSubmit(onSumit)}>
                        ...
                        <div>
                            <div>
                                <input 
                                    id="agree" 
                                    type="checkbox"
                                    className="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600 `${errors.agree ? border-red-500 focus:ring-red-500 : border-gray-300}`"
                                />
                                <label for="agree" className="ml-2 text-sm font-bold text-gray-900 dark:text-white">ฉันยอมรับข้อตกลงและเงื่อนไข</label>
                    ...
                    <div className="flex justify-center mt-5 w-full">
                        ...
                        >
                            {loading ? "กําลังบันทึก..." : "ลงทะเบียน"}
                        </button>
                    </div>
