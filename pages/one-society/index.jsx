        ...
        <div className="flex flex-col w-full min-h-screen">
            <div className="flex flex-row items-center justify-between gap-4 w-full mt-2 px-2">
                <div className="flex flex-row items-center gap-2">
                    ...
                    >
                        <svg className="w-auto h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 122.99 20.23">
                            <g>
                            <rect fill="currentColor" y="1.59" width="69.81" height="18.64"/>
                            <g>
                                <path fill="currentColor" d="M9.25,3.39c3.03,0,4.8,1.54,4.8,4.21s-1.77,4.21-4.8,4.21h-2.68v3.76h-2.01V3.39h4.69ZM9.25,10.09c1.82,0,2.75-.84,2.75-2.5s-.93-2.49-2.75-2.49h-2.68v4.99h2.68Z"/>
                                <path fill="currentColor" d="M21.1,6.37v1.79h-.6c-1.95,0-3.09,1.23-3.09,3.48v3.93h-1.9V6.37h1.86v1.84c.69-1.23,1.82-1.84,3.13-1.84h.6Z"/>
                                <path fill="currentColor" d="M21.57,10.95c0-2.79,2.12-4.82,5.01-4.82s4.97,2.03,4.97,4.82-2.1,4.86-4.97,4.86-5.01-2.05-5.01-4.86ZM29.57,10.95c0-1.81-1.27-3.11-3-3.11s-3.03,1.3-3.03,3.11,1.28,3.15,3.03,3.15,3-1.32,3-3.15Z"/>
                                <path fill="currentColor" d="M47.44,10.2v5.36h-1.97v-5.36c0-1.53-.74-2.36-2.08-2.36-1.42,0-2.1.78-2.1,2.36v5.36h-1.95v-5.36c0-1.58-.69-2.36-2.1-2.36-1.34,0-2.08.84-2.08,2.36v5.36h-1.97v-5.36c0-2.61,1.4-4.08,3.87-4.08,1.53,0,2.7.69,3.26,1.88.58-1.19,1.77-1.88,3.28-1.88,2.48,0,3.87,1.47,3.87,4.08Z"/>
                                <path fill="currentColor" d="M59.29,10.98c0,2.77-1.94,4.82-4.82,4.82-1.17,0-2.4-.52-3.15-1.34v4.26h-1.97v-7.56c0-3.03,1.97-5.04,4.99-5.04s4.95,2.07,4.95,4.86ZM57.32,10.98c0-1.84-1.27-3.15-2.98-3.15s-3.02,1.3-3.02,3.15,1.27,3.11,3.02,3.11,2.98-1.28,2.98-3.11Z"/>
                                <path fill="currentColor" d="M65.99,13.81v1.66c-.61.2-1.15.3-1.71.3-2.07,0-3.22-1.29-3.22-3.54V3.18h1.97v3.18h2.72v1.64h-2.72v4.39c0,1.1.52,1.68,1.55,1.68.43,0,.93-.09,1.41-.26Z"/>
                            </g>
                            <g>
                                <path fill="currentColor" d="M72.75,13.55l1.68-2.12c1.19,1.08,2.61,1.69,3.95,1.69,1.04,0,1.6-.33,1.6-.99,0-.78-1.08-1.02-2.53-1.32-2.53-.52-4.21-1.54-4.21-3.91s1.86-3.74,4.77-3.74c1.92,0,4.08.86,5.16,2.05l-1.84,2.01c-.95-.86-2.29-1.4-3.5-1.4-.97,0-1.49.32-1.49.91,0,.54.39.75,2.2,1.14,3.39.73,4.65,1.82,4.65,4.04,0,2.44-1.82,3.89-4.9,3.89-2.27,0-4.41-.84-5.53-2.25Z"/>
                                <path fill="currentColor" d="M94.27,10.55v5.01h-3.05v-4.9c0-1.29-.63-1.99-1.79-1.99s-1.82.71-1.82,1.99v4.9h-3.05V3.18h3.05v3.76c.61-.54,1.43-.82,2.44-.82,2.61,0,4.23,1.69,4.23,4.43Z"/>
                                <path fill="currentColor" d="M104.52,10.01v5.55h-2.89v-.84c-.56.65-1.43,1.01-2.53,1.01-2.05,0-3.44-1.19-3.44-2.96s1.43-2.92,3.59-2.92c.91,0,1.66.19,2.23.56v-.35c0-.97-.67-1.53-1.79-1.53-.82,0-1.6.35-2.29,1.02l-1.56-1.81c.95-.99,2.57-1.62,4.17-1.62,2.79,0,4.5,1.49,4.5,3.89ZM101.49,12.7c0-.67-.6-1.13-1.49-1.13s-1.47.45-1.47,1.12.6,1.14,1.47,1.14,1.49-.46,1.49-1.12Z"/>
                                <path fill="currentColor" d="M112.6,6.37v3h-.54c-1.86,0-2.79.97-2.79,2.92v3.28h-3.03V6.37h2.9v1.96c.67-1.23,1.77-1.96,3.05-1.96h.41Z"/>
                                <path fill="currentColor" d="M122.99,11.88h-6.87c.28.95,1.14,1.54,2.35,1.54.8,0,1.68-.28,2.57-.84l1.36,1.9c-1.01.86-2.4,1.32-4.02,1.32-3.15,0-5.27-1.96-5.27-4.88s2.1-4.8,5.04-4.8,4.84,1.9,4.84,4.73v1.02ZM116.12,9.96h4.06c-.13-.91-.84-1.42-1.94-1.42s-1.86.52-2.12,1.42Z"/>
                            </g>
                            <g>
                                <path fill="currentColor" d="M101.8,1.52h.94l-.61,2.78c-.04.21-.21.32-.46.32s-.41-.11-.47-.32l-.52-1.75-.53,1.75c-.06.21-.23.32-.49.32s-.41-.12-.46-.32l-.61-2.78h.95l.29,1.6.36-1.3c.06-.21.23-.32.49-.32s.42.11.47.32l.37,1.32.29-1.62Z"/>
                                <path fill="currentColor" d="M102.88,4.07l.52-.59c.28.26.69.42,1.03.42.25,0,.37-.07.37-.22s-.07-.18-.45-.25c-.88-.15-1.28-.47-1.28-1,0-.59.5-.98,1.27-.98.55,0,1.08.21,1.37.55l-.51.53c-.25-.21-.61-.35-.9-.35-.2,0-.31.07-.31.2,0,.12.11.18.48.27.92.17,1.26.43,1.26.99,0,.62-.51,1-1.32,1-.59,0-1.13-.2-1.52-.58Z"/>
                                <path fill="currentColor" d="M104.19,1.14v-.51h-.32v-.63h1.04v.47h1.05v.68h-1.76Z"/>
                                <path fill="currentColor" d="M109.36,3.04c0,.95-.66,1.6-1.63,1.6-1.02,0-1.61-.64-1.61-1.57,0-.08,0-.2.01-.26h1.76v.63h-.87c.1.27.34.44.67.44.44,0,.73-.33.73-.82s-.29-.82-.73-.82c-.31,0-.54.11-.73.35l-.73-.47c.37-.42.89-.65,1.49-.65.98,0,1.64.64,1.64,1.59Z"/>
                                <path fill="currentColor" d="M111.98,1.52h.93v1.78c0,.85-.44,1.33-1.2,1.33-.46,0-.81-.2-.98-.55v.47h-.88V1.52h.93v1.71c0,.39.23.62.63.62.36,0,.58-.22.58-.58v-1.75Z"/>
                                <path fill="currentColor" d="M113.63,4.57V1.52h.93v3.04h-.93ZM115.1,4.57V1.52h.93v3.04h-.93Z"/>
                                <path fill="currentColor" d="M119.55,3.25v.2c0,.76-.52,1.2-1.46,1.2s-1.46-.44-1.46-1.18c0-.36.11-.67.41-1.16.02-.04.05-.08.07-.12h-.46v-.67h1.42v.08c0,.18-.03.34-.09.51h.13c.3,0,.48-.21.48-.55v-.05h.91v.05c0,.39-.19.68-.51.83.36.11.56.4.56.84ZM118.62,3.24c0-.3-.22-.46-.64-.46h-.32c-.08.19-.11.37-.11.55,0,.33.21.54.55.54.32,0,.51-.18.51-.5v-.13Z"/>
                                <path fill="currentColor" d="M119.82,4.07l.52-.59c.28.26.69.42,1.03.42.25,0,.37-.07.37-.22s-.07-.18-.45-.25c-.88-.15-1.28-.47-1.28-1,0-.59.5-.98,1.27-.98.55,0,1.08.21,1.37.55l-.51.53c-.25-.21-.61-.35-.9-.35-.2,0-.31.07-.31.2,0,.12.11.18.48.27.92.17,1.26.43,1.26.99,0,.62-.51,1-1.32,1-.59,0-1.13-.2-1.52-.58Z"/>
                                <path fill="currentColor" d="M121.18,1.14v-.31c0-.45.26-.7.73-.7h.88v.7h-.54c-.15,0-.22.07-.22.19v.12h-.84Z"/>
                            </g>
                            </g>
                        </svg>
                    </h1>
