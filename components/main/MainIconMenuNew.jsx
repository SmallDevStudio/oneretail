...
export default function MainIconMenu({ setLinkModal }) {
    ...
    const menu = [
        { 
            lable: "เกม", 
            icon:
            <svg className="w-12 h-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 376.66 236.28">
        ...
        { 
            lable: "ตารางอบรม",
            icon:
            <svg className="w-10 h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 287.01 320.21">
        ...
        },
        {
          lable: "แลกของรางวัล",
          icon:
            <svg className="w-10 h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 339.74 322.34">
        ...
        },
        {
            lable: "Prompt Share",
            icon: 
            <svg className="w-12 h-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 69.81 51.44">
                <g>
                    <g>
                    <path fill="currentColor" d="M3.57,48.63l2.09-2.65c1.49,1.35,3.26,2.12,4.93,2.12,1.3,0,2-.42,2-1.23,0-.98-1.35-1.28-3.16-1.65-3.16-.65-5.26-1.93-5.26-4.89s2.33-4.68,5.96-4.68c2.4,0,5.1,1.07,6.45,2.56l-2.3,2.51c-1.19-1.07-2.86-1.75-4.38-1.75-1.21,0-1.86.4-1.86,1.14,0,.67.49.93,2.75,1.42,4.24.91,5.82,2.28,5.82,5.05,0,3.05-2.28,4.86-6.12,4.86-2.84,0-5.52-1.05-6.91-2.82Z"/>
                    <path fill="currentColor" d="M30.47,44.88v6.26h-3.82v-6.12c0-1.61-.79-2.49-2.23-2.49s-2.28.88-2.28,2.49v6.12h-3.82v-15.47h3.82v4.7c.77-.67,1.79-1.02,3.05-1.02,3.26,0,5.28,2.12,5.28,5.54Z"/>
                    <path fill="currentColor" d="M43.29,44.21v6.93h-3.61v-1.05c-.7.81-1.79,1.26-3.16,1.26-2.56,0-4.3-1.49-4.3-3.7s1.79-3.65,4.49-3.65c1.14,0,2.07.23,2.79.7v-.44c0-1.21-.84-1.91-2.23-1.91-1.02,0-2,.44-2.86,1.28l-1.95-2.26c1.19-1.23,3.21-2.02,5.21-2.02,3.49,0,5.63,1.86,5.63,4.86ZM39.5,47.56c0-.84-.74-1.42-1.86-1.42s-1.84.56-1.84,1.4.74,1.42,1.84,1.42,1.86-.58,1.86-1.4Z"/>
                    <path fill="currentColor" d="M53.39,39.65v3.75h-.67c-2.33,0-3.49,1.21-3.49,3.65v4.1h-3.79v-11.5h3.63v2.44c.84-1.54,2.21-2.44,3.82-2.44h.51Z"/>
                    <path fill="currentColor" d="M66.37,46.53h-8.59c.35,1.19,1.42,1.93,2.93,1.93,1,0,2.09-.35,3.21-1.05l1.7,2.37c-1.26,1.07-3,1.65-5.03,1.65-3.93,0-6.58-2.44-6.58-6.1s2.63-6,6.31-6,6.05,2.37,6.05,5.91v1.28ZM57.78,44.14h5.07c-.16-1.14-1.05-1.77-2.42-1.77s-2.33.65-2.65,1.77Z"/>
                    </g>
                    <g>
                    <path fill="currentColor" d="M12.69,3.86h2.39l-1.54,7.03c-.11.52-.54.82-1.17.82s-1.05-.28-1.2-.81l-1.33-4.43-1.34,4.43c-.16.52-.59.81-1.23.81s-1.05-.3-1.16-.82l-1.54-7.03h2.4l.72,4.06.92-3.28c.14-.52.59-.81,1.23-.81s1.06.28,1.2.81l.93,3.34.72-4.12Z"/>
                    <path fill="currentColor" d="M15.4,10.3l1.32-1.48c.71.65,1.74,1.07,2.6,1.07.64,0,.95-.18.95-.55s-.18-.47-1.15-.64c-2.22-.38-3.25-1.2-3.25-2.55,0-1.5,1.27-2.47,3.23-2.47,1.4,0,2.73.52,3.48,1.39l-1.29,1.34c-.62-.52-1.56-.89-2.29-.89-.51,0-.78.17-.78.51,0,.31.28.47,1.22.68,2.33.42,3.18,1.09,3.18,2.5,0,1.57-1.29,2.55-3.35,2.55-1.48,0-2.86-.51-3.86-1.46Z"/>
                    <path fill="currentColor" d="M18.71,2.9v-1.3h-.82V0h2.63v1.19h2.66v1.71h-4.47Z"/>
                    <path fill="currentColor" d="M31.79,7.69c0,2.41-1.68,4.06-4.13,4.06-2.57,0-4.07-1.63-4.07-3.99,0-.21.01-.51.03-.67h4.46v1.6h-2.21c.24.69.85,1.1,1.7,1.1,1.1,0,1.85-.83,1.85-2.08s-.74-2.08-1.85-2.08c-.78,0-1.37.28-1.85.89l-1.84-1.2c.93-1.07,2.26-1.65,3.76-1.65,2.49,0,4.16,1.61,4.16,4.02Z"/>
                    <path fill="currentColor" d="M38.42,3.86h2.36v4.51c0,2.15-1.1,3.38-3.04,3.38-1.17,0-2.05-.5-2.49-1.39v1.2h-2.23V3.86h2.36v4.33c0,.98.59,1.57,1.58,1.57.91,0,1.46-.55,1.46-1.47V3.86Z"/>
                    <path fill="currentColor" d="M42.61,11.57V3.86h2.36v7.71h-2.36ZM46.31,11.57V3.86h2.36v7.71h-2.36Z"/>
                    <path fill="currentColor" d="M57.58,8.22v.5c0,1.94-1.33,3.04-3.69,3.04s-3.71-1.1-3.71-2.98c0-.92.27-1.68,1.05-2.93.06-.1.13-.2.17-.3h-1.17v-1.68h3.61v.21c0,.45-.07.86-.23,1.3h.34c.75,0,1.22-.54,1.22-1.39v-.13h2.31v.13c0,.99-.48,1.73-1.3,2.11.92.28,1.41,1.02,1.41,2.12ZM55.23,8.2c0-.75-.57-1.16-1.61-1.16h-.81c-.2.48-.28.93-.28,1.4,0,.85.52,1.36,1.4,1.36.82,0,1.3-.47,1.3-1.26v-.34Z"/>
                    <path fill="currentColor" d="M58.24,10.3l1.32-1.48c.71.65,1.74,1.07,2.6,1.07.64,0,.95-.18.95-.55s-.18-.47-1.15-.64c-2.22-.38-3.25-1.2-3.25-2.55,0-1.5,1.27-2.47,3.23-2.47,1.4,0,2.73.52,3.48,1.39l-1.29,1.34c-.62-.52-1.56-.89-2.29-.89-.51,0-.78.17-.78.51,0,.31.28.47,1.22.68,2.33.42,3.18,1.09,3.18,2.5,0,1.57-1.29,2.55-3.35,2.55-1.48,0-2.86-.51-3.86-1.46Z"/>
                    <path fill="currentColor" d="M61.69,2.9v-.79c0-1.13.65-1.77,1.84-1.77h2.23v1.77h-1.37c-.37,0-.57.17-.57.48v.31h-2.14Z"/>
                    </g>
                    <rect fill="currentColor" y="14.95" width="69.81" height="18.64"/>
                    <g>
                    <path fill="white" d="M9.25,16.74c3.03,0,4.8,1.54,4.8,4.21s-1.77,4.21-4.8,4.21h-2.68v3.76h-2.01v-12.17h4.69ZM9.25,23.45c1.82,0,2.75-.84,2.75-2.49s-.93-2.49-2.75-2.49h-2.68v4.99h2.68Z"/>
                    <path fill="white" d="M21.1,19.72v1.79h-.6c-1.95,0-3.09,1.23-3.09,3.48v3.93h-1.9v-9.2h1.86v1.84c.69-1.23,1.82-1.84,3.13-1.84h.6Z"/>
                    <path fill="white" d="M21.57,24.3c0-2.79,2.12-4.82,5.01-4.82s4.97,2.03,4.97,4.82-2.1,4.86-4.97,4.86-5.01-2.05-5.01-4.86ZM29.57,24.3c0-1.81-1.27-3.11-3-3.11s-3.03,1.3-3.03,3.11,1.28,3.15,3.03,3.15,3-1.32,3-3.15Z"/>
                    <path fill="white" d="M47.44,23.56v5.36h-1.97v-5.36c0-1.53-.74-2.36-2.08-2.36-1.42,0-2.1.78-2.1,2.36v5.36h-1.95v-5.36c0-1.58-.69-2.36-2.1-2.36-1.34,0-2.08.84-2.08,2.36v5.36h-1.97v-5.36c0-2.61,1.4-4.08,3.87-4.08,1.53,0,2.7.69,3.26,1.88.58-1.19,1.77-1.88,3.28-1.88,2.48,0,3.87,1.47,3.87,4.08Z"/>
                    <path fill="white" d="M59.29,24.34c0,2.77-1.94,4.82-4.82,4.82-1.17,0-2.4-.52-3.15-1.34v4.26h-1.97v-7.56c0-3.03,1.97-5.04,4.99-5.04s4.95,2.07,4.95,4.86ZM57.32,24.34c0-1.84-1.27-3.15-2.98-3.15s-3.02,1.3-3.02,3.15,1.27,3.11,3.02,3.11,2.98-1.28,2.98-3.11Z"/>
                    <path fill="white" d="M65.99,27.17v1.66c-.61.2-1.15.3-1.71.3-2.07,0-3.22-1.29-3.22-3.54v-9.05h1.97v3.18h2.72v1.64h-2.72v4.39c0,1.1.52,1.68,1.55,1.68.43,0,.93-.09,1.41-.26Z"/>
                    </g>
                </g>
            </svg>,
            link: "/prompt-share"
        },
        {
            lable: "ตารางอันดับ",
            icon:
            <svg className="w-10 h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 371.11 357.77">
        ...
        },
        {
            lable: "แคมเปญ",
            icon:
            <svg className="w-10 h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 387.64 401.16">
        ...
        },
        {
            ...
            <svg className="w-14 h-14 mb-[-6px]" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 24 24">
                ...
                <path fill="currentColor" d="M17.3,13.4c-.3,0-.5.2-.5.5s.2.5.5.5.5-.2.5-.5-.2-.5-.5-.5ZM15.6,13.9c0-.9.7-1.6,1.6-1.6s1.6.7,1.6,1.6-.7,1.6-1.6,1.6-1.6-.7-1.6-1.6Z"/>
                <path fill="currentColor" d="M11.9,16.9c-.6,0-1.1.5-1.1,1.1s-.3.6-.6.6-.6-.3-.6-.6c0-1.2,1-2.2,2.2-2.2s2.2,1,2.2,2.2-.3.6-.6.6-.6-.3-.6-.6c0-.6-.5-1.1-1.1-1.1Z"/>
                <path fill="currentColor" d="M6.5,16.9c-.6,0-1.1.5-1.1,1.1s-.3.6-.6.6-.6-.3-.6-.6c0-1.2,1-2.2,2.2-2.2s2.2,1,2.2,2.2-.3.6-.6.6-.6-.3-.6-.6c0-.6-.5-1.1-1.1-1.1Z"/>
                <path fill="currentColor" d="M7.6,9c-.9,0-1.6.7-1.6,1.6s-.3.6-.6.6-.6-.3-.6-.6c0-1.5,1.2-2.7,2.7-2.7s2.7,1.2,2.7,2.7-.3.6-.6.6-.6-.3-.6-.6c0-.9-.7-1.6-1.6-1.6Z"/>
                <path fill="currentColor" d="M17.3,16.9c-.6,0-1.1.5-1.1,1.1s-.3.6-.6.6-.6-.3-.6-.6c0-1.2,1-2.2,2.2-2.2s2.2,1,2.2,2.2-.3.6-.6.6-.6-.3-.6-.6c0-.6-.5-1.1-1.1-1.1Z"/>
                <path fill="currentColor" d="M10.3,4.2c0-.3.3-.6.6-.6h6.6c1.2,0,2.1.9,2.1,2.1v3.4c0,1.2-.9,2.1-2.1,2.1h-5.3c-.3,0-.6-.3-.6-.6s.3-.6.6-.6h5.3c.5,0,.9-.4.9-.9v-3.4c0-.5-.4-.9-.9-.9h-6.6c-.3,0-.6-.3-.6-.6Z"/>
                <path fill="currentColor" d="M14.6,6.1c0-.3.3-.6.6-.6h1.5c.3,0,.6.3.6.6s-.3.6-.6.6h-1.5c-.3,0-.6-.3-.6-.6Z"/>
                <path fill="currentColor" d="M12.9,8.1c0-.3.3-.6.6-.6h3.3c.3,0,.6.3.6.6s-.3.6-.6.6h-3.3c-.3,0-.6-.3-.6-.6Z"/>
            </svg>,
            link: "/courses",
        },
        {
            ...
            <svg className="w-12 h-12" xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 287 320.2">
                <path fill="white" d="M252.2,106.2v105.1c5.3-1.4,9.2-6.2,9.2-11.9V64.1c0-6.8-5.6-12.3-12.3-12.3H73.6c-6.8,0-12.3,5.6-12.3,12.3v3.8h152.7c21.1,0,38.3,17.2,38.3,38.3Z"/>
