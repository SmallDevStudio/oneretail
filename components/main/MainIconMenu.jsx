...
export default function MainIconMenu() {
    ...
    return (
        <div className="flex flex-col justify-center items-center p-5">
                    <div className="grid grid-cols-3 grid-rows-2 gap-4 p-4 w-full overflow-x-auto scrollbar-hide">
                            <button 
                                className="flex-col inline-flex items-center justify-center p-0.5 mb-2 me-2 overflow-x-hidden text-sm font-bold rounded-2xl border-4 border-[#0056FF] bg-white"
                        ...
                        >
                            <FiGift 
                                className="w-10 h-10 mb-1 text-[#F68B1F]"
                            />
                            <span className="text-sm text-bold text-nowrap text-[#0056FF]">Reward</span>
                        </button>
                        ...
                        >
                            <IoShareSocial 
                                className="w-10 h-10 mb-1 text-[#F68B1F]"
                            />
                            <span className="text-sm text-bold text-nowrap text-[#0056FF]">Feed</span>
                        </button>
                        ...
                        >
                            <FaUserGraduate 
                                className="w-10 h-10 mb-1 text-[#F68B1F]"
                            />
                            <span className="text-sm text-bold text-nowrap text-[#0056FF]">Personalized</span>
                        </button>
