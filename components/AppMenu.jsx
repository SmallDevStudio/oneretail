    ...
    return (
        <nav className="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600 shadow-lg" style={{ boxShadow: "0 0 10px 0 rgba(0, 0, 0, 0.1)", fontFamily: "ttb" }}>
                <div className="grid h-full max-w-lg grid-cols-5 mx-auto font-medium">
                    <button type="button" className={`inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group ${isActive('/learning') ? "text-blue-600" : ""}`} 
                        onClick={() => router.push('/learning')}>
                    <svg className="w-7 h-7 mb-1 group-hover:text-blue-600 dark:group-hover:text-blue-500 group-hover:w-9 group-hover:h-9" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 305.91 220.6">
                        ...
                        <span className="text-sm group-hover:text-[#F68B1F] text-nowrap">Learning</span>
                    </button>

                    <button type="button" className={`inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group ${isActive('/stores') ? "text-blue-600" : ""}`} 
                        onClick={() => router.push('/stores')}>
                        <svg className="w-7 h-7 mb-1 group-hover:text-blue-600 dark:group-hover:text-blue-500 group-hover:w-9 group-hover:h-9" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 218.49 224.15">
                        ...
                        <span className="text-sm group-hover:text-[#F68B1F] text-nowrap">Success Story</span>
                    </button>

                    <button type="button" className={`inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group ${isActive('/main') ? "text-blue-600" : ""}`} 
                        onClick={() => router.push('/main')}>
                        <svg className="w-7 h-7 mb-1 group-hover:text-blue-600 dark:group-hover:text-blue-500 group-hover:w-9 group-hover:h-9" aria-hidden="true"  xmlns="http://www.w3.org/2000/svg" viewBox="0 0 216.12 216.12">
                        ...
                        <span className="text-sm group-hover:text-[#F68B1F] text-nowrap">Home</span>
                    </button>

                    <button type="button" className={`inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group ${isActive('/club') ? "text-blue-600" : ""}`} 
                        onClick={() => router.push('/club')}>
                        <svg className="w-7 h-7 mb-1 group-hover:text-blue-600 dark:group-hover:text-blue-500 group-hover:w-9 group-hover:h-9" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 218.44 218.44">
                        ...
                        <span className="text-sm group-hover:text-[#F68B1F] text-nowrap">One Retail Club</span>
                    </button>

                    <button type="button" className={`inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group ${isActive('/profile') ? "text-blue-600" : ""}`} 
                        onClick={() => router.push('/profile')}>
                        <svg className="w-7 h-7 mb-1 group-hover:text-blue-600 dark:group-hover:text-blue-500 group-hover:w-9 group-hover:h-9" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 163.14 204.47">
                        ...
                        <span className="text-sm group-hover:text-[#F68B1F] text-nowrap">Profile</span>
                    </button>
                </div>
            </nav>
    )
