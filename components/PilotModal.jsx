...
const PilotModal = ({ isOpen, onRequestClose, score }) => {
  return (
    <Modal 
        isOpen={isOpen} 
    ...
    >
      ...
      <div className="flex flex-col justify-center items-center ">
        <p className="flex text-2xl font-bold mt-5">
          ขอบคุณที่ร่วมกิจกรรม Pilot
        </p>
        <p className="text-[200px] font-bold text-[#0056FF] mt-[-50px]">
            {score}
        </p>
        <div className="flex flex-row justify-end items-baseline mt-[-80px] w-full mr-20">
      ...
      <div className="modal-footer flex justify-center w-full">
        <button onClick={onRequestClose} className="bg-[#0056FF] text-white p-2 rounded-full mt-4">Close</button>
      </div>
    </Modal>
  );
};
