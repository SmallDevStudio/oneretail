...
const SendPointsCoins = () => {
  ...
  const handleSend = async () => {
    if (taggedUsers.length === 0) {
      setErr((prevErr) => ({
        ...prevErr,
        taggedUsers: "กรุณากรอก taggedUsers",
      }));
      toast.error("กรุณากรอก taggedUsers", {
        position: "top-right",
        autoClose: 3000,
      });
      return;
    ...
    if (!point && !coins) {
      setErr((prevErr) => ({
        ...prevErr,
        point: "กรุณากรอก point หรือ coins",
      }));
      toast.error("กรุณากรอก point หรือ coins", {
        position: "top-right",
        autoClose: 3000,
      });
      return;
    ...
    try {
      ...
      setLoading(false);
      toast.success(`ส่ง Point/Coins สำเร็จ ${results.length} รายการ`, {
        position: "top-right",
        autoClose: 3000,
      });
      ...
      toast.error("เกิดข้อผิดพลาดในการส่ง Point/Coins", {
        position: "top-right",
        autoClose: 3000,
      });
    }
