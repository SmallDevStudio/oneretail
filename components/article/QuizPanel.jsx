  ...
  return (
    <div className="flex flex-col px-5 py-2 text-sm w-full">
      <div className="flex flex-row mb-2">
        ...
        <span className="whitespace-pre-line">{quiz?.question}</span>
      </div>
      ...
      {quiz?.options.map((option, index) => (
        ...
        >
          <div
            className={`flex flex-row rounded-3xl px-2 py-1 ${
      ...
      <div className="flex justify-center">
        <button
          className="bg-[#0056FF] rounded-3xl px-2 py-1 mt-2 w-2/6 text-white font-bold"
