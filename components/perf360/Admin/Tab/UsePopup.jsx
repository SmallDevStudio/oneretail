...
export default function UsePopup() {
  ...
  useEffect(() => {
    ...
    const fetchActivity = async () => {
      let url = "/api/perf360/admin/usepopup";
      const query = [];
  ...
  const exportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(wb, ws, "Popup Logs");
    XLSX.writeFile(wb, "popup_activity.xlsx");
  };

  return (
    <div className="flex flex-col p-4 w-full">
      <h2 className="text-lg font-bold text-center">การเข้าใช้งานระบบ Popup</h2>
