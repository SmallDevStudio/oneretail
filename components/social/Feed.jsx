                  ...
                  <div className="flex flex-row w-full gap-2">
                    ...
                    <div className="flex flex-col text-sm w-[calc(100%-50px)]">
                      <div className="flex flex-row flex-wrap items-center gap-2 text-sm font-bold text-[#0056FF]">
                        <span
                          onClick={() =>
                            router.push(`/p/${post?.user?.userId}`)
                          }
                        >
                          {post?.user?.fullname}
                        </span>
                    ...
                    {(user?.user?.role === "admin" ||
                      ...
                      <div className="relative">
                        ...
                        <Menu
                          anchorEl={anchorEl}
                          open={
                            Boolean(anchorEl) && currentOption?.id === post._id
                          }
                        ...
                        >
                          <MenuItem
                            onClick={() => {
                              handlePin(currentOption.id, post.hasPin);
                              handleOptionClose();
                            }}
                          >
                            {post.hasPin ? "Unpin" : "Pin"}
                          </MenuItem>
                          <MenuItem
                            onClick={() => {
