...
export default function Events({ events, mutate }) {
  ...
  const handleSubmit = async (e) => {
    ...
    mutate();
    handleClose();
    setFilteredEvents(events); // Update filtered events after submission
  };

  const handleDelete = async (id) => {
    await axios.delete(`/api/events/${id}`);
    mutate();
    setFilteredEvents(events); // Update filtered events after deletion
  };
