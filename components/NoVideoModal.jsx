...
const NoVideoModal = ({ isOpen, onRequestClose }) => {
  return (
    <Modal 
        isOpen={isOpen} 
      ...
      <h2 className='text-center font-bold mt-5'>คุณเคยได้รับคะแนนจากการดูวิดีโอนี้แล้ว</h2>
      <button onClick={onRequestClose} className="mt-4 bg-blue-500 text-white px-4 py-2 rounded-full">
        ปิด
      </button>
